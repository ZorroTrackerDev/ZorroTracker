...
window.ipc = {
	...
	driver: {
		...
		pianoTrigger: (note:number, velocity:number, channel:number, instrument:number, polyphony:boolean) =>
			_async(ipcEnum.DriverFunc, [ "pianoTrigger", [ note, velocity, channel, instrument, polyphony, ], ]) as Promise<boolean>,
